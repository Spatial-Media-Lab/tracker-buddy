...
class Values : public Destination
{
    class Component : public Destination::Widget, private juce::Timer
    {
    public:
        Component (Values& v) : Widget (v), Values (v)
        {
        ...
        {
            auto data = RotationData (Values.getQuaternion());
...
public:
    ...
    Values (TrackerInterface& source) : Destination (source)
    {
    }
    ...
    {
        return std::make_unique<Values::Component> (*this);
    }
